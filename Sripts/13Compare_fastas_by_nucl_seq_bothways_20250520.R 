...
setwd("/xdisk/mcnew/popgenworkshop/testmt")

# ##Load the fasta files
#
seqs_Run1 <- readLines("Data/RUN1_NEW_Sequences_20250507.fas")

seqs_Run2 <- readLines("Data/RUN2_NEW_Sequences_20250507.fas")
#
# # Create an output path
#
path_out <- "/xdisk/mcnew/popgenworkshop/testmt/results"
#
